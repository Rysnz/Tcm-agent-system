...
class AzureOpenAIModelProvider(IModelProvider):
    """Azure OpenAI模型提供商"""
    ...
    def __init__(self):
                ...
                return [
                    {
                        ...
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入Azure OpenAI API Key")
                    },
                    {
                        "name": "endpoint",
                        "label": _("Endpoint"),
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入Azure OpenAI Endpoint，如https://your-resource.openai.azure.com/")
                    },
                    {
                        "name": "api_version",
                        "label": _("API Version"),
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入API Version，如2023-05-15")
                    }
                ]
        ...
        self.model_info_manage.append_model_info_list([
            ModelInfo('gpt-4', '', ModelTypeConst.LLM, simple_credential, None),
            ModelInfo('gpt-35-turbo', '', ModelTypeConst.LLM, simple_credential, None),
            ModelInfo('text-embedding-ada-002', '', ModelTypeConst.EMBEDDING, simple_credential, None),
        ])
