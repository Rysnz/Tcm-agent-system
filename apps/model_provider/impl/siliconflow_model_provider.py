...
class SiliconFlowModelProvider(IModelProvider):
    """SiliconFlow模型提供商"""
    ...
    def __init__(self):
                ...
                return [
                    {
                        ...
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入SiliconFlow API Key")
                    }
                ]
        ...
        self.model_info_manage.append_model_info_list([
            ...
            ModelInfo('meta-llama/Llama-3-70B-Instruct', '', ModelTypeConst.LLM, simple_credential, None),
