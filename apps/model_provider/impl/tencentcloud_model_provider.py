...
class TencentCloudModelProvider(IModelProvider):
    ...
    def __init__(self):
            ...
            def get_model_params_setting_form(self, model_name):
                ...
                return [
                    ...
                    },
                    {
                        ...
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入腾讯云Secret Key")
                    },
                    {
                        "name": "region",
                        "label": _("Region"),
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入腾讯云Region，如ap-guangzhou")
                    }
                ]
        ...
        self.model_info_manage.append_model_info_list([
            ModelInfo('hunyuan-pro', '', ModelTypeConst.LLM, simple_credential, None),
            ModelInfo('hunyuan-standard', '', ModelTypeConst.LLM, simple_credential, None),
