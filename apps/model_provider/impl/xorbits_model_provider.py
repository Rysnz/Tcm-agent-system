...
class XorbitsModelProvider(IModelProvider):
    """Xorbits Inference模型提供商"""
                ...
                return [
                    {
                        ...
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入Xorbits API Key")
                    },
                    {
                        "name": "base_url",
                        "label": _("Base URL"),
                        "field_type": "input",
                        "required": True,
                        "placeholder": _("请输入Xorbits服务URL，如https://api.xorbits.cn")
                    }
                ]
